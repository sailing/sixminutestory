...
RSpec.describe PromptsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested prompt as @prompt" do
      prompt = Prompt.create! valid_attributes
      get :show, params: {id: prompt.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested prompt as @prompt" do
      prompt = Prompt.create! valid_attributes
      get :edit, params: {id: prompt.to_param}, session: valid_session
      expect(assigns(:prompt)).to eq(prompt)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Prompt" do
        expect {
          post :create, params: {prompt: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved prompt as @prompt" do
        post :create, params: {prompt: invalid_attributes}, session: valid_session
        expect(assigns(:prompt)).to be_a_new(Prompt)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested prompt" do
        prompt = Prompt.create! valid_attributes
        put :update, params: {id: prompt.to_param, prompt: new_attributes}, session: valid_session
        prompt.reload
      ...
      it "assigns the requested prompt as @prompt" do
        prompt = Prompt.create! valid_attributes
        put :update, params: {id: prompt.to_param, prompt: valid_attributes}, session: valid_session
        expect(assigns(:prompt)).to eq(prompt)
      end
    ...
    context "with invalid params" do
      it "assigns the prompt as @prompt" do
        prompt = Prompt.create! valid_attributes
        put :update, params: {id: prompt.to_param, prompt: invalid_attributes}, session: valid_session
        expect(assigns(:prompt)).to eq(prompt)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested prompt" do
      prompt = Prompt.create! valid_attributes
      expect {
        delete :destroy, params: {id: prompt.to_param}, session: valid_session
      }.to change(Prompt, :count).by(-1)
    end
