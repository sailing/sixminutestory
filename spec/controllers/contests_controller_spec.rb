...
RSpec.describe ContestsController, type: :controller do
  ...
  let(:valid_attributes) {
    FactoryBot.attributes_for(:contest)
  }
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "creates a new Contest with a valid duration" do
        post :create, params: {contest: valid_attributes}, session: valid_session

        expect(Contest.first.duration).to eq valid_attributes[:starts_at]...valid_attributes[:ends_at]
      end

      it "creates a new Contest with a valid duration" do
        post :create, params: {contest: valid_attributes}, session: valid_session

        expect(Contest.first.duration.count).to eq(7)
      end
